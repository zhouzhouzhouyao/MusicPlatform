...
//            System.out.println(e.getClass() + " : " + e.getMessage());
    ...
    public void findAllNews () {
        try {
            List<News> News = userService.findAllNews(100002, ShowNewsAction.SELF);
...
//            user.setSex(false);
            if (userService.updateUser(user, UpdateUserAction.UPDATE_INFO)) {
                System.out.println("用户信息修改成功");
            }
            if (userService.updateUser(user, UpdateUserAction.UPDATE_VIP)) {
    ...
    public void updateSongList () {
        try {
            if (userService.updateSongList(100001, 0, 10000001, SongAction.ADD_SONG)) {
                System.out.println("歌曲添加成功");
            }
            if (userService.updateSongList(100001, 0, 10000002, SongAction.ADD_SONG)) {
                System.out.println("歌曲添加成功");
            }
            if (userService.updateSongList(100001, 2, 10000002, SongAction.ADD_SONG)) {
                System.out.println("歌曲添加成功");
            }
            if (userService.updateSongList(100001, 2, 10000001, SongAction.ADD_SONG)) {
                System.out.println("歌曲添加成功");
            }
            if (userService.updateSongList(100002, 0, 10000000, SongAction.ADD_SONG)) {
                System.out.println("歌曲添加成功");
            }
            if (userService.updateSongList(100002, 1, 10000001, SongAction.ADD_SONG)) {
                System.out.println("歌曲添加成功");
            }
            if (userService.updateSongList(100002, 0, 10000002, SongAction.REMOVE_SONG)) {
                System.out.println("歌曲删除成功");
            }
            if (userService.updateSongList(100003, 0, 10000001, SongAction.ADD_SONG)) {
                System.out.println("歌曲添加成功");
            }
    ...
    public void updateFollow () {
        try {
            if (userService.updateFollow(100001, 530500, FollowAction.ADD_FOLLOW)) {
                System.out.println("关注用户成功");
            }
            if (userService.updateFollow(100002, 100003, FollowAction.ADD_FOLLOW)) {
                System.out.println("关注用户成功");
            }
            if (userService.updateFollow(100002, 100001, FollowAction.ADD_FOLLOW)) {
                System.out.println("关注用户成功");
            }
            if (userService.updateFollow(100003, 100001, FollowAction.ADD_FOLLOW)) {
                System.out.println("关注用户成功");
            }
            if (userService.updateFollow(100001, 100002, FollowAction.REMOVE_FOLLOW)) {
