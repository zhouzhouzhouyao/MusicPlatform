...
//            e.printStackTrace();
    ...
    public void testUpdateSongList () {
        userService.updateSongList(100001, 0, 10000001, SongAction.ADD_SONG);
        userService.updateSongList(100001, 0, 10000002, SongAction.ADD_SONG);
        userService.updateSongList(100001, 1, 10000002, SongAction.ADD_SONG);
        userService.updateSongList(100001, 2, 10000001, SongAction.ADD_SONG);
        userService.updateSongList(100002, 0, 10000000, SongAction.ADD_SONG);
        userService.updateSongList(100002, 1, 10000001, SongAction.ADD_SONG);
        userService.updateSongList(100002, 0, 10000002, SongAction.REMOVE_SONG);
        userService.updateSongList(100002, 0, 10000001, null);
        userService.updateSongList(100003, 0, 10000001, SongAction.ADD_SONG);
        userService.updateSongListName(100001, 4, "11");
    }
    
    @Test
    public void testFollow () {
        userService.updateFollow(100001, 398457, FollowAction.ADD_FOLLOW);
        userService.updateFollow(100002, 398457, FollowAction.ADD_FOLLOW);
        userService.updateFollow(100003, 398457, FollowAction.ADD_FOLLOW);
        userService.updateFollow(100002, 100003, FollowAction.ADD_FOLLOW);
        userService.updateFollow(100002, 100001, FollowAction.ADD_FOLLOW);
        userService.updateFollow(100003, 100001, FollowAction.ADD_FOLLOW);
    }
    ...
    public void showNews () {
        List<News> News = userService.findAllNews(100002, ShowNewsAction.ALL);
        for(News news : News) {
