...
public interface IUserDao {
    ...
    @Select("select uid, phone, username, vip, sex, birthday, location from User")
    ...
    @Results(id = "songMap", value = {@Result(column = "fullName", property = "songs", many = @Many(select = "com.dao.IUserDao.findAllSong", fetchType = FetchType.EAGER))})
